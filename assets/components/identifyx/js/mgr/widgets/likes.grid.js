...
Ext.extend(IdentifyX.grid.Likes, MODx.grid.Grid, {
    ...
    getFields: function(config) {
        return ['id', 'finger', 'res_id', 'createdby', 'createdon', 'user_name', 'title'];
    },

    getColumns: function(config) {
        return [{
            header: _('identifyx_like_id'),
            dataIndex: 'id',
            sortable: true,
            width: 80,
        }, {
            ...
            header: _('identifyx_item_work_name'),
            dataIndex: 'title',
            sortable: false,
            width: 150,
        }, {
            header: _('identifyx_item_work_id'),
            dataIndex: 'res_id',
            sortable: false,
            width: 80,
        }, {
            ...
            xtype: 'datecolumn',
	        format: 'Y-m-d H:i:s',
            header: _('identifyx_item_createdon'),
            dataIndex: 'createdon',
            sortable: true,
            width: 150,
            // }, {
