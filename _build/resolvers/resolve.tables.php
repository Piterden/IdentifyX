...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('identifyx_core_path', null, $modx->getOption('core_path') . 'components/identifyx/') . 'model/';
            $modx->addPackage('identifyx', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/identifyx/model/schema/identifyx.mysql.schema.xml';
