...
$_lang['identifyx'] = 'IdentifyX';
$_lang['identifyx_menu_desc'] = 'Модуль идентификации пользователей по уникальному изображению.';
...
$_lang['identifyx_items_remove'] = 'Удалить элементы';
...
$_lang['identifyx_user_enable'] = 'Разблокировать пользователя';
$_lang['identifyx_users_enable'] = 'Разблокировать пользователей';
$_lang['identifyx_user_disable'] = 'Заблокировать пользователя';
$_lang['identifyx_users_disable'] = 'Заблокировать пользователей';
$_lang['identifyx_user_err_ns'] = 'Пользователь не указан.';
$_lang['identifyx_user_err_nf'] = 'Не найден пользователь с ID';

$_lang['identifyx_item_err_fingerprint'] = 'Ошибка при генерации отпечатка.';
$_lang['identifyx_item_err_ns'] = 'Элемент не указан.';
$_lang['identifyx_item_err_nf'] = 'Элемент не найден.';
$_lang['identifyx_item_err_remove'] = 'Ошибка при удалении элемента.';
$_lang['identifyx_item_err_save'] = 'Ошибка при сохранении элемента.';
